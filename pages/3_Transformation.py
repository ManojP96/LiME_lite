...
summary_df['Adstock_range']=summary_df['Adstock_range'].astype(str)
summary_df['Lag_range']=summary_df['Lag_range'].astype(str)
...
if len(f_v)>0 and st.session_state['df'] is not None :
  with st.form('Filter'):
